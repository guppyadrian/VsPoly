...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_bitwit_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_bitwit_voices_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_hexadec_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_hexadec_voices_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_offsettest_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_polygonal_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_polygonal_voices_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_music_lofly_ogg extends null { }
...
@:keep @:expose('__ASSET__assets_fonts_comicsans_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_comicsans_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/comicsans.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Comic Sans MS"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_fridayfunkin_otf') @:noCompletion #if display private #end class __ASSET__assets_fonts_fridayfunkin_otf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/fridayfunkin.otf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Friday Funkin Regular"; super (); }}
