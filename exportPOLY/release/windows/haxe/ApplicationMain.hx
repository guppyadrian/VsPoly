...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("VSPoly", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("VSPoly", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "VSPoly";
		app.meta["name"] = "Poly Kade Engine :)";
