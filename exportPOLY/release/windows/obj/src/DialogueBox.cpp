...
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_264_update,"DialogueBox","update",0x23306964,"DialogueBox.update","DialogueBox.hx",264,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_283_startDialogue,"DialogueBox","startDialogue",0x59859d9f,"DialogueBox.startDialogue","DialogueBox.hx",283,0x0149b4eb)
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_335_cleanDialog,"DialogueBox","cleanDialog",0x0fc249f6,"DialogueBox.cleanDialog","DialogueBox.hx",335,0x0149b4eb)
...
HXLINE( 280)		this->isEnding = false;
...
HXLINE( 178)		 ::flixel::FlxSprite _hx_tmp4 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.9)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.9)),null());
HXDLIN( 178)		::String library1 = null();
HXDLIN( 178)		this->handSelect = _hx_tmp4->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE( 179)		this->add(this->handSelect);
...
HXLINE( 259)						 ::flixel::addons::text::FlxTypeText fh2 = _gthis->swagDialogue;
HXDLIN( 259)						fh2->set_alpha((fh2->alpha - ((Float)0.2)));
HXLINE( 260)						_gthis->dropText->set_alpha(_gthis->swagDialogue->alpha);
            					}
            					HX_END_LOCAL_FUNC1((void))

            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::DialogueBox,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
            						HX_GC_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_264_update)
HXLINE( 265)						_gthis->finishThing();
HXLINE( 266)						_gthis->kill();
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXLINE( 263)					 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)1.2), ::Dynamic(new _hx_Closure_1(_gthis)),null());
            				}
            			}
            			else {
HXLINE( 272)				this->dialogueList->remove(this->dialogueList->__get(0));
HXLINE( 273)				this->startDialogue();
            			}
            		}
...
void DialogueBox_obj::startDialogue(){
            	HX_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_283_startDialogue)
HXLINE( 284)		this->cleanDialog();
HXLINE( 290)		this->swagDialogue->resetText(this->dialogueList->__get(0));
HXLINE( 291)		this->swagDialogue->start(((Float)0.04),true,null(),null(),null());
HXLINE( 293)		::String _hx_switch_0 = this->curCharacter;
            		if (  (_hx_switch_0==HX_("bf",c4,55,00,00)) ){
HXLINE( 308)			if (::_DialogueBox::DialogueBox_Fields__obj::twoBoxes) {
HXLINE( 309)				this->boxBf->set_visible(true);
HXLINE( 310)				this->box->set_visible(false);
            			}
HXLINE( 312)			this->portraitLeft->set_visible(false);
HXLINE( 313)			this->portraitMiddle->set_visible(false);
HXLINE( 314)			if (!(this->portraitRight->visible)) {
HXLINE( 316)				this->portraitRight->set_visible(true);
HXLINE( 317)				this->portraitRight->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 307)			goto _hx_goto_13;
            		}
            		if (  (_hx_switch_0==HX_("dad",47,36,4c,00)) ){
HXLINE( 296)			if (::_DialogueBox::DialogueBox_Fields__obj::twoBoxes) {
HXLINE( 297)				this->box->set_visible(true);
HXLINE( 298)				this->boxBf->set_visible(false);
            			}
HXLINE( 300)			this->portraitRight->set_visible(false);
HXLINE( 301)			this->portraitMiddle->set_visible(false);
HXLINE( 302)			if (!(this->portraitLeft->visible)) {
HXLINE( 304)				this->portraitLeft->set_visible(true);
HXLINE( 305)				this->portraitLeft->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 295)			goto _hx_goto_13;
            		}
            		if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 320)			if (::_DialogueBox::DialogueBox_Fields__obj::twoBoxes) {
HXLINE( 321)				this->boxBf->set_visible(true);
HXLINE( 322)				this->box->set_visible(false);
            			}
HXLINE( 324)			this->portraitLeft->set_visible(false);
HXLINE( 325)			this->portraitRight->set_visible(false);
HXLINE( 326)			if (!(this->portraitMiddle->visible)) {
HXLINE( 327)				this->portraitMiddle->set_visible(true);
HXLINE( 328)				this->portraitMiddle->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
...
void DialogueBox_obj::cleanDialog(){
            	HX_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_335_cleanDialog)
HXLINE( 336)		::Array< ::String > splitName = this->dialogueList->__get(0).split(HX_(":",3a,00,00,00));
HXLINE( 337)		this->curCharacter = splitName->__get(1);
HXLINE( 338)		this->dialogueList[0] = ::StringTools_obj::trim(this->dialogueList->__get(0).substr((splitName->__get(1).length + 2),null()));
            	}
