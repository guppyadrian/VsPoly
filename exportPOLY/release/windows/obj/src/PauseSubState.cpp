...
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_213_destroy,"PauseSubState","destroy",0xc2ba82f3,"PauseSubState.destroy","PauseSubState.hx",213,0x953dc7b7)
HX_LOCAL_STACK_FRAME(_hx_pos_17d383cbce329512_220_changeSelection,"PauseSubState","changeSelection",0x8f960fb5,"PauseSubState.changeSelection","PauseSubState.hx",220,0x953dc7b7)
...
HXLINE( 100)			if ((this->pauseMusic->_volume < ((Float)0.5))) {
HXLINE( 101)				 ::flixel::_hx_system::FlxSound fh = this->pauseMusic;
HXDLIN( 101)				fh->set_volume((fh->_volume + (((Float)0.01) * elapsed)));
            			}
            		}
...
HXLINE( 107)		bool leftP = ::PlayerSettings_obj::player1->controls->_leftP->check();
HXLINE( 108)		bool rightP = ::PlayerSettings_obj::player1->controls->_rightP->check();
HXLINE( 109)		bool accepted = ::PlayerSettings_obj::player1->controls->_accept->check();
HXLINE( 110)		Float oldOffset = ( (Float)(0) );
HXLINE( 111)		::String songPath = ((HX_("assets/data/",f9,10,73,a0) + ( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase()) + HX_("/",2f,00,00,00));
HXLINE( 113)		if (upP) {
...
HXLINE( 123)				if (leftP) {
HXLINE( 125)					oldOffset = ::PlayState_obj::songOffset;
HXLINE( 126)					 ::Dynamic _hx_tmp = ::hx::ClassOf< ::PlayState >();
HXDLIN( 126)					::PlayState_obj::songOffset = (::PlayState_obj::songOffset - ( (Float)(1) ));
HXLINE( 127)					::sys::FileSystem_obj::rename(((songPath + oldOffset) + HX_(".offset",41,ee,1a,d9)),((songPath + ::PlayState_obj::songOffset) + HX_(".offset",41,ee,1a,d9)));
HXLINE( 128)					this->perSongOffset->set_text((((HX_("Additive Offset (Left, Right): ",5d,60,ef,2e) + ::PlayState_obj::songOffset) + HX_(" - Description - ",ca,32,1d,cd)) + HX_("Adds value to global offset, per song.",5a,ef,29,77)));
HXLINE( 131)					if (!(this->offsetChanged)) {
HXLINE( 133)						this->grpMenuShit->clear();
HXLINE( 135)						this->menuItems = ::Array_obj< ::String >::fromData( _hx_array_data_08e59567_7,2);
HXLINE( 137)						{
HXLINE( 137)							int _g = 0;
HXDLIN( 137)							int _g1 = this->menuItems->length;
HXDLIN( 137)							while((_g < _g1)){
HXLINE( 137)								_g = (_g + 1);
HXDLIN( 137)								int i = (_g - 1);
HXLINE( 139)								 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false);
HXLINE( 140)								songText->isMenuItem = true;
HXLINE( 141)								songText->targetY = ( (Float)(i) );
HXLINE( 142)								this->grpMenuShit->add(songText).StaticCast<  ::Alphabet >();
            							}
            						}
HXLINE( 145)						this->changeSelection(null());
HXLINE( 147)						this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
HXLINE( 148)						this->offsetChanged = true;
            					}
            				}
            				else {
HXLINE( 150)					if (rightP) {
HXLINE( 152)						oldOffset = ::PlayState_obj::songOffset;
HXLINE( 153)						 ::Dynamic _hx_tmp = ::hx::ClassOf< ::PlayState >();
HXDLIN( 153)						::PlayState_obj::songOffset = (::PlayState_obj::songOffset + 1);
HXLINE( 154)						::sys::FileSystem_obj::rename(((songPath + oldOffset) + HX_(".offset",41,ee,1a,d9)),((songPath + ::PlayState_obj::songOffset) + HX_(".offset",41,ee,1a,d9)));
HXLINE( 155)						this->perSongOffset->set_text((((HX_("Additive Offset (Left, Right): ",5d,60,ef,2e) + ::PlayState_obj::songOffset) + HX_(" - Description - ",ca,32,1d,cd)) + HX_("Adds value to global offset, per song.",5a,ef,29,77)));
HXLINE( 156)						if (!(this->offsetChanged)) {
HXLINE( 158)							this->grpMenuShit->clear();
HXLINE( 160)							this->menuItems = ::Array_obj< ::String >::fromData( _hx_array_data_08e59567_8,2);
HXLINE( 162)							{
HXLINE( 162)								int _g = 0;
HXDLIN( 162)								int _g1 = this->menuItems->length;
HXDLIN( 162)								while((_g < _g1)){
HXLINE( 162)									_g = (_g + 1);
HXDLIN( 162)									int i = (_g - 1);
HXLINE( 164)									 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false);
HXLINE( 165)									songText->isMenuItem = true;
HXLINE( 166)									songText->targetY = ( (Float)(i) );
HXLINE( 167)									this->grpMenuShit->add(songText).StaticCast<  ::Alphabet >();
            								}
            							}
HXLINE( 170)							this->changeSelection(null());
HXLINE( 172)							this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
HXLINE( 173)							this->offsetChanged = true;
            						}
            					}
            				}
            			}
            		}
HXLINE( 178)		if (accepted) {
HXLINE( 180)			::String daSelected = this->menuItems->__get(this->curSelected);
HXLINE( 182)			::String _hx_switch_0 = daSelected;
            			if (  (_hx_switch_0==HX_("Exit to menu",82,87,9a,a9)) ){
HXLINE( 189)				::PlayState_obj::loadRep = false;
HXLINE( 190)				if (::hx::IsNotNull( ::PlayState_obj::lua )) {
HXLINE( 192)					lua_close(::PlayState_obj::lua);
HXLINE( 193)					::PlayState_obj::lua = null();
            				}
HXLINE( 195)				if (::PlayState_obj::offsetTesting) {
HXLINE( 197)					::PlayState_obj::offsetTesting = false;
HXLINE( 198)					{
...
HXLINE( 201)					 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 187)				 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
...
void PauseSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_213_destroy)
HXLINE( 214)		this->pauseMusic->destroy();
...
void PauseSubState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_17d383cbce329512_220_changeSelection)
HXLINE( 221)		 ::PauseSubState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 225)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 226)			this->curSelected = 0;
            		}
HXLINE( 228)		int bullShit = 0;
HXLINE( 230)		{
HXLINE( 230)			int _g = 0;
HXDLIN( 230)			::Array< ::Dynamic> _g1 = this->grpMenuShit->members;
HXDLIN( 230)			while((_g < _g1->length)){
HXLINE( 230)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 230)				_g = (_g + 1);
HXLINE( 232)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 233)				bullShit = (bullShit + 1);
HXLINE( 235)				item->set_alpha(((Float)0.6));
HXLINE( 238)				if ((item->targetY == 0)) {
HXLINE( 240)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
