...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_comicsans_ttf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_fridayfunkin_otf >());
...
HXLINE(  79)		{
HXLINE(  79)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v4);
            		}
...
HXLINE(  88)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  89)		if (::hx::IsNotNull( library )) {
HXLINE(  89)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  90)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  91)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week1",bd,95,be,c7));
HXLINE(  92)		if (::hx::IsNotNull( library )) {
HXLINE(  92)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  93)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week1",bd,95,be,c7));
            		}
HXLINE(  94)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  95)		if (::hx::IsNotNull( library )) {
HXLINE(  95)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  96)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
