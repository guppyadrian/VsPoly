...
HXLINE(  79)		{
HXLINE(  79)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/week69.json",1f,3c,40,9e));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week69",37,74,04,ff),v4);
            		}
HXLINE(  80)		{
...
HXLINE(  92)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week1",bd,95,be,c7));
HXLINE(  93)		if (::hx::IsNotNull( library )) {
HXLINE(  93)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  94)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week1",bd,95,be,c7));
            		}
HXLINE(  95)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
