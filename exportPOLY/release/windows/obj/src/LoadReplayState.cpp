...
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_101_getWeekNumbFromSong,"LoadReplayState","getWeekNumbFromSong",0x140b87fb,"LoadReplayState.getWeekNumbFromSong","LoadReplayState.hx",101,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_114_addSong,"LoadReplayState","addSong",0x8f3688ec,"LoadReplayState.addSong","LoadReplayState.hx",114,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_118_addWeek,"LoadReplayState","addWeek",0x91d3c50b,"LoadReplayState.addWeek","LoadReplayState.hx",118,0xb45e587a)
static const ::String _hx_array_data_8a203cc4_11[] = {
	HX_("bf",c4,55,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_134_update,"LoadReplayState","update",0x971f8073,"LoadReplayState.update","LoadReplayState.hx",134,0xb45e587a)
HX_LOCAL_STACK_FRAME(_hx_pos_67c80871309dda48_165_changeSelection,"LoadReplayState","changeSelection",0x45620112,"LoadReplayState.changeSelection","LoadReplayState.hx",165,0xb45e587a)
...
HXLINE( 162)		this->isSettingControl = false;
...
HXLINE(  55)				::String string = this->controlsStrings->__get(i);
HXLINE(  56)				this->actualNames[i] = string;
HXLINE(  57)				 ::Replay rep = ::Replay_obj::LoadReplay(string);
HXLINE(  58)				::Array< ::String > _hx_tmp = this->controlsStrings;
HXDLIN(  58)				::String _hx_tmp1 = (string.split(HX_("time",0d,cc,fc,4c))->__get(0) + HX_(" ",20,00,00,00));
HXDLIN(  58)				::String _hx_tmp2;
HXDLIN(  58)				if (::hx::IsEq( rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic),3 )) {
HXLINE(  58)					_hx_tmp2 = HX_("FLUSHED",03,c8,20,ea);
            				}
            				else {
HXLINE(  58)					if (::hx::IsEq( rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic),2 )) {
HXLINE(  58)						_hx_tmp2 = HX_("HARD",eb,f6,c8,2f);
            					}
            					else {
HXLINE(  58)						if (::hx::IsEq( rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic),1 )) {
HXLINE(  58)							_hx_tmp2 = HX_("EASY",02,54,cd,2d);
            						}
            						else {
HXLINE(  58)							_hx_tmp2 = HX_("NORMAL",27,1e,ec,e2);
            						}
            					}
            				}
HXDLIN(  58)				_hx_tmp[i] = (_hx_tmp1 + _hx_tmp2);
            			}
            		}
HXLINE(  61)		if ((this->controlsStrings->length == 0)) {
HXLINE(  62)			this->controlsStrings->push(HX_("No Replays...",81,d1,ed,00));
            		}
HXLINE(  64)		menuBG1->set_color(-1412611);
HXLINE(  65)		menuBG1->setGraphicSize(::Std_obj::_hx_int((menuBG1->get_width() * ((Float)1.1))),null());
HXLINE(  66)		menuBG1->updateHitbox();
HXLINE(  67)		menuBG1->screenCenter(null());
HXLINE(  68)		menuBG1->set_antialiasing(true);
HXLINE(  69)		this->add(menuBG1);
HXLINE(  71)		this->grpControls =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  72)		this->add(this->grpControls);
HXLINE(  74)		{
HXLINE(  74)			int _g2 = 0;
HXDLIN(  74)			int _g3 = this->controlsStrings->length;
HXDLIN(  74)			while((_g2 < _g3)){
HXLINE(  74)				_g2 = (_g2 + 1);
HXDLIN(  74)				int i = (_g2 - 1);
HXLINE(  76)				 ::Alphabet controlLabel =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->controlsStrings->__get(i),true,false);
HXLINE(  77)				controlLabel->isMenuItem = true;
HXLINE(  78)				controlLabel->targetY = ( (Float)(i) );
HXLINE(  79)				this->grpControls->add(controlLabel).StaticCast<  ::Alphabet >();
            			}
            		}
HXLINE(  84)		this->versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 34),0,HX_("Replay Loader (ESCAPE TO GO BACK)\nNOTICE!!!! Replays are in a beta stage, and they are probably not 100% correct. expect misses and other stuff that isn't there!",b8,5a,29,fe),12,null());
HXLINE(  85)		this->versionShit->scrollFactor->set(null(),null());
HXLINE(  86)		this->versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  87)		this->add(this->versionShit);
HXLINE(  90)		this->poggerDetails =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,34,0,HX_("Replay Details - \nnone",38,c3,7c,19),12,null());
HXLINE(  91)		this->poggerDetails->scrollFactor->set(null(),null());
HXLINE(  92)		this->poggerDetails->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  93)		this->add(this->poggerDetails);
HXLINE(  95)		this->changeSelection(0);
HXLINE(  97)		this->super::create();
            	}


int LoadReplayState_obj::getWeekNumbFromSong(::String songName){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_101_getWeekNumbFromSong)
HXLINE( 102)		int week = 0;
HXLINE( 103)		{
HXLINE( 103)			int _g = 0;
HXDLIN( 103)			int _g1 = this->songs->length;
HXDLIN( 103)			while((_g < _g1)){
HXLINE( 103)				_g = (_g + 1);
HXDLIN( 103)				int i = (_g - 1);
HXLINE( 105)				 ::SongMetadata pog = this->songs->__get(i).StaticCast<  ::SongMetadata >();
HXLINE( 106)				if ((pog->songName.toLowerCase() == songName)) {
HXLINE( 107)					week = pog->week;
            				}
            			}
            		}
HXLINE( 109)		return week;
            	}
...
void LoadReplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_114_addSong)
HXDLIN( 114)		::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN( 114)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter));
            	}
...
void LoadReplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_118_addWeek)
HXLINE( 119)		if (::hx::IsNull( songCharacters )) {
HXLINE( 120)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_8a203cc4_11,1);
            		}
HXLINE( 122)		int num = 0;
HXLINE( 123)		{
HXLINE( 123)			int _g = 0;
HXDLIN( 123)			while((_g < songs->length)){
HXLINE( 123)				::String song = songs->__get(_g);
HXDLIN( 123)				_g = (_g + 1);
HXLINE( 125)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 127)				if ((songCharacters->length != 1)) {
HXLINE( 128)					num = (num + 1);
            				}
            			}
            		}
            	}
...
void LoadReplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_67c80871309dda48_134_update)
...
HXDLIN( 145)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 145)			_hx_tmp = (Dynamic( this->grpControls->members->__get(this->curSelected)).StaticCast<  ::Alphabet >()->text != HX_("No Replays...",81,d1,ed,00));
            		}
            		else {
HXLINE( 145)			_hx_tmp = false;
            		}
HXDLIN( 145)		if (_hx_tmp) {
HXLINE( 147)			::haxe::Log_obj::trace((HX_("loading ",24,de,81,cb) + this->actualNames->__get(this->curSelected)),::hx::SourceInfo(HX_("source/LoadReplayState.hx",6e,34,7a,fb),147,HX_("LoadReplayState",c4,3c,20,8a),HX_("update",09,86,05,87)));
HXLINE( 148)			::PlayState_obj::rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 150)			::PlayState_obj::loadRep = true;
HXLINE( 152)			::String poop = ( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ).toLowerCase();
HXDLIN( 152)			::String poop1 = ::Highscore_obj::formatSong(poop,( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) ));
HXLINE( 154)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ).toLowerCase());
HXLINE( 155)			::PlayState_obj::isStoryMode = false;
HXLINE( 156)			::PlayState_obj::storyDifficulty = ( (int)(::PlayState_obj::rep->replay->__Field(HX_("songDiff",7a,ba,41,30),::hx::paccDynamic)) );
HXLINE( 157)			::PlayState_obj::storyWeek = this->getWeekNumbFromSong(( (::String)(::PlayState_obj::rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) ));
HXLINE( 158)			{
HXLINE( 158)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
void LoadReplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_67c80871309dda48_165_changeSelection)
HXLINE( 170)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 170)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 172)		 ::LoadReplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 172)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 174)		if ((this->curSelected < 0)) {
HXLINE( 175)			this->curSelected = (this->grpControls->length - 1);
            		}
HXLINE( 176)		if ((this->curSelected >= this->grpControls->length)) {
HXLINE( 177)			this->curSelected = 0;
            		}
HXLINE( 179)		 ::Replay rep = ::Replay_obj::LoadReplay(this->actualNames->__get(this->curSelected));
HXLINE( 181)		 ::flixel::text::FlxText _hx_tmp2 = this->poggerDetails;
HXDLIN( 181)		::String _hx_tmp3 = ((HX_("Replay Details - \nDate Created: ",9c,0e,70,a7) + ::Std_obj::string( ::Dynamic(rep->replay->__Field(HX_("timestamp",d6,d4,ce,a5),::hx::paccDynamic)))) + HX_("\nSong: ",65,cd,f3,01));
HXDLIN( 181)		::String _hx_tmp4;
HXDLIN( 181)		if (::hx::IsNotEq( rep->replay->__Field(HX_("replayGameVer",2a,ad,0b,ce),::hx::paccDynamic),::Replay_obj::version )) {
HXLINE( 181)			_hx_tmp4 = HX_("OUTDATED",28,3f,a2,5d);
            		}
            		else {
HXLINE( 181)			_hx_tmp4 = HX_("Latest",67,79,f7,89);
            		}
HXDLIN( 181)		_hx_tmp2->set_text(( (::String)((((_hx_tmp3 + rep->replay->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) + HX_("\nReplay Version: ",8f,f9,99,d3)) + _hx_tmp4)) ));
HXLINE( 185)		int bullShit = 0;
HXLINE( 187)		{
HXLINE( 187)			int _g = 0;
HXDLIN( 187)			::Array< ::Dynamic> _g1 = this->grpControls->members;
HXDLIN( 187)			while((_g < _g1->length)){
HXLINE( 187)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 187)				_g = (_g + 1);
