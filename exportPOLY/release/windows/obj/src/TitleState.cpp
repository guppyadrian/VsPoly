...
HXLINE( 352)			money->set_y((money->y + ((i * 60) + 200)));
...
HXLINE( 362)		coolText->set_y((coolText->y + ((this->textGroup->length * 60) + 200)));
...
HXLINE( 390)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 393)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,1));
            			}
            			break;
            			case (int)2: {
HXLINE( 395)				this->addMoreText(HX_("retrobop",65,15,2c,2f));
HXLINE( 396)				this->addMoreText(HX_("guppy",0b,15,f1,9b));
            			}
            			break;
            			case (int)3: {
