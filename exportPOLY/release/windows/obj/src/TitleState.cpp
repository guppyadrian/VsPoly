...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_468_skipIntro,"TitleState","skipIntro",0xc9924038,"TitleState.skipIntro","TitleState.hx",468,0xd132a6e5)
...
HXLINE( 464)		this->skippedIntro = false;
...
HXLINE( 166)		this->logoBl =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,350,-100,null());
...
HXLINE( 184)		this->gfDance =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-575,null());
HXLINE( 185)		 ::flixel::FlxSprite _hx_tmp2 = this->gfDance;
HXDLIN( 185)		::String library1 = null();
HXDLIN( 185)		::String _hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("polymenu/poly_assets",f2,2b,3e,57)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 185)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("polymenu/poly_assets",f2,2b,3e,57)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE( 186)		this->gfDance->animation->addByPrefix(HX_("dance",33,83,83,d4),HX_("Dad idle dance",80,2a,95,5c),24,null(),null(),null());
HXLINE( 187)		this->gfDance->scale->set(((Float)1.2),((Float)1.2));
...
HXLINE( 397)		this->gfDance->animation->play(HX_("dance",33,83,83,d4),null(),null(),null());
HXLINE( 401)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 404)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_18,1));
            			}
            			break;
            			case (int)2: {
HXLINE( 406)				this->addMoreText(HX_("retrobop",65,15,2c,2f));
HXLINE( 407)				this->addMoreText(HX_("guppy",0b,15,f1,9b));
            			}
            			break;
            			case (int)3: {
HXLINE( 410)				this->addMoreText(HX_("present",fb,3a,dc,39));
            			}
            			break;
            			case (int)4: {
HXLINE( 414)				this->deleteCoolText();
            			...
            			break;
            			case (int)5: {
HXLINE( 419)				if (::Main_obj::watermarks) {
HXLINE( 420)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_19,2));
            				}
            				else {
HXLINE( 422)					this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_20,2));
            				}
            			}
            			break;
            			case (int)7: {
HXLINE( 424)				if (::Main_obj::watermarks) {
HXLINE( 425)					this->addMoreText(HX_("KadeDeveloper",93,41,22,2c));
            				}
            				else {
HXLINE( 428)					this->addMoreText(HX_("Newgrounds",cc,13,58,ed));
HXLINE( 429)					this->ngSpr->set_visible(true);
            				}
            			}
            			break;
            			case (int)8: {
HXLINE( 433)				this->deleteCoolText();
HXLINE( 434)				this->ngSpr->set_visible(false);
            			}
            			break;
            			case (int)9: {
HXLINE( 440)				this->createCoolText(::Array_obj< ::String >::__new(1)->init(0,this->curWacky->__get(0)));
            			}
            			break;
            			case (int)11: {
HXLINE( 443)				this->addMoreText(this->curWacky->__get(1));
            			}
            			break;
            			case (int)12: {
HXLINE( 446)				this->deleteCoolText();
            			}
            			break;
            			case (int)13: {
HXLINE( 451)				this->addMoreText(HX_("Friday",ff,00,5d,e6));
            			}
            			break;
            			case (int)14: {
HXLINE( 454)				this->addMoreText(HX_("Night",b8,29,f7,2e));
            			}
            			break;
            			case (int)15: {
HXLINE( 457)				this->addMoreText(HX_("Funkin",51,26,e4,a3));
            			}
            			break;
            			case (int)16: {
HXLINE( 460)				this->skipIntro();
            			}
            			break;
            		}
            	}
...
void TitleState_obj::skipIntro(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_468_skipIntro)
HXDLIN( 468)		if (!(this->skippedIntro)) {
HXLINE( 470)			this->remove(this->ngSpr,null());
HXLINE( 472)			::flixel::FlxG_obj::camera->flash(-1,4,null(),null());
HXLINE( 473)			this->remove(this->credGroup,null());
