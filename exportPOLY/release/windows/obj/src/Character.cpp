...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_547_update,"Character","update",0x0e18944e,"Character.update","Character.hx",547,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_583_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",583,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_644_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",644,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_675_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",675,0xf073a2d5)
...
HXLINE( 289)			this->animation->addByPrefix(HX_("shocked",41,ec,7d,6e),HX_("BF hit",f7,85,10,c7),12,false,null(),null());
HXLINE( 290)			this->animation->addByPrefix(HX_("shockHold",c1,c5,df,67),HX_("BF shock",06,e8,72,65),12,true,null(),null());
...
HXLINE( 306)			this->addOffset(HX_("shocked",41,ec,7d,6e),0,0);
HXLINE( 308)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 310)			this->set_flipX(true);
HXLINE( 269)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-car",cb,95,e2,07)) ){
HXLINE( 341)			::String library = null();
HXDLIN( 341)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("bfCar",b0,c8,e3,b0)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 341)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("bfCar",b0,c8,e3,b0)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXLINE( 353)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 354)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 355)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 356)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 357)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 358)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 359)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 360)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 361)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
...
HXDLIN( 313)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/bfChristmas",d1,87,5c,b1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 313)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/bfChristmas",d1,87,5c,b1)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 314)			this->set_frames(tex1);
HXLINE( 315)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f),24,false,null(),null());
HXLINE( 316)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF NOTE UP0",23,e8,67,d4),24,false,null(),null());
HXLINE( 317)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF NOTE LEFT0",77,e0,7c,76),24,false,null(),null());
HXLINE( 318)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF NOTE RIGHT0",06,3f,26,eb),24,false,null(),null());
HXLINE( 319)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF NOTE DOWN0",bc,3f,f1,e1),24,false,null(),null());
HXLINE( 320)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF NOTE UP MISS",8f,08,36,ae),24,false,null(),null());
HXLINE( 321)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF NOTE LEFT MISS",e3,ba,cf,a7),24,false,null(),null());
HXLINE( 322)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF NOTE RIGHT MISS",f2,0c,cd,25),24,false,null(),null());
HXLINE( 323)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF NOTE DOWN MISS",a8,a0,05,a9),24,false,null(),null());
HXLINE( 324)			this->animation->addByPrefix(HX_("hey",dc,42,4f,00),HX_("BF HEY",60,1e,f8,c6),24,false,null(),null());
HXLINE( 326)			this->addOffset(HX_("idle",14,a7,b3,45),-5,null());
HXLINE( 327)			this->addOffset(HX_("singUP",6a,52,21,b9),-29,27);
HXLINE( 328)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-38,-7);
HXLINE( 329)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),12,-6);
HXLINE( 330)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-10,-50);
HXLINE( 331)			this->addOffset(HX_("singUPmiss",66,22,08,8a),-29,27);
HXLINE( 332)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),-30,21);
HXLINE( 333)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),12,24);
HXLINE( 334)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),-11,-19);
HXLINE( 335)			this->addOffset(HX_("hey",dc,42,4f,00),7,4);
HXLINE( 337)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 339)			this->set_flipX(true);
HXLINE( 312)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-pixel",fd,03,90,37)) ){
HXLINE( 366)			::String library = null();
HXDLIN( 366)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPixel",be,30,3a,8f)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 366)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPixel",be,30,3a,8f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 367)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("BF IDLE",f0,de,ca,52),24,false,null(),null());
HXLINE( 368)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF UP NOTE",7b,9d,4e,d3),24,false,null(),null());
HXLINE( 369)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("BF LEFT NOTE",4f,b9,34,d9),24,false,null(),null());
HXLINE( 370)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("BF RIGHT NOTE",b2,df,15,96),24,false,null(),null());
HXLINE( 371)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("BF DOWN NOTE",14,9f,6a,da),24,false,null(),null());
HXLINE( 372)			this->animation->addByPrefix(HX_("singUPmiss",66,22,08,8a),HX_("BF UP MISS",85,d8,a0,d2),24,false,null(),null());
HXLINE( 373)			this->animation->addByPrefix(HX_("singLEFTmiss",d2,2f,9c,b6),HX_("BF LEFT MISS",59,f4,86,d8),24,false,null(),null());
HXLINE( 374)			this->animation->addByPrefix(HX_("singRIGHTmiss",89,cc,65,e3),HX_("BF RIGHT MISS",bc,1a,68,95),24,false,null(),null());
HXLINE( 375)			this->animation->addByPrefix(HX_("singDOWNmiss",ad,e9,88,e4),HX_("BF DOWN MISS",1e,da,bc,d9),24,false,null(),null());
HXLINE( 377)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 378)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 379)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 380)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 381)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 382)			this->addOffset(HX_("singUPmiss",66,22,08,8a),null(),null());
HXLINE( 383)			this->addOffset(HX_("singRIGHTmiss",89,cc,65,e3),null(),null());
HXLINE( 384)			this->addOffset(HX_("singLEFTmiss",d2,2f,9c,b6),null(),null());
HXLINE( 385)			this->addOffset(HX_("singDOWNmiss",ad,e9,88,e4),null(),null());
HXLINE( 387)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 388)			this->updateHitbox();
HXLINE( 390)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 392)			this->set_width((this->get_width() - ( (Float)(100) )));
HXLINE( 393)			this->set_height((this->get_height() - ( (Float)(100) )));
HXLINE( 395)			this->set_antialiasing(false);
HXLINE( 397)			this->set_flipX(true);
HXLINE( 365)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("bf-pixel-dead",34,d0,3d,c4)) ){
HXLINE( 399)			::String library = null();
HXDLIN( 399)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPixelsDEAD",19,2b,e2,7b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 399)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPixelsDEAD",19,2b,e2,7b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 400)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("BF Dies pixel",d5,56,ac,77),24,false,null(),null());
HXLINE( 401)			this->animation->addByPrefix(HX_("firstDeath",e4,d8,fc,14),HX_("BF Dies pixel",d5,56,ac,77),24,false,null(),null());
HXLINE( 402)			this->animation->addByPrefix(HX_("deathLoop",b8,0b,79,2e),HX_("Retry Loop",5c,76,15,41),24,true,null(),null());
HXLINE( 403)			this->animation->addByPrefix(HX_("deathConfirm",2c,44,2b,12),HX_("RETRY CONFIRM",08,8c,5f,fd),24,false,null(),null());
HXLINE( 404)			this->animation->play(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
HXLINE( 406)			this->addOffset(HX_("firstDeath",e4,d8,fc,14),null(),null());
HXLINE( 407)			this->addOffset(HX_("deathLoop",b8,0b,79,2e),-37,null());
HXLINE( 408)			this->addOffset(HX_("deathConfirm",2c,44,2b,12),-37,null());
HXLINE( 409)			this->playAnim(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
...
HXLINE( 414)			this->set_flipX(true);
...
HXDLIN( 478)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/mom_dad_christmas_assets",b9,c9,6d,11)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 478)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/mom_dad_christmas_assets",b9,c9,6d,11)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 479)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Parent Christmas Idle",c8,04,64,10),24,false,null(),null());
HXLINE( 480)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Parent Up Note Dad",88,99,f7,ad),24,false,null(),null());
HXLINE( 481)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Parent Down Note Dad",21,a5,93,34),24,false,null(),null());
HXLINE( 482)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Parent Left Note Dad",dc,f8,16,c4),24,false,null(),null());
HXLINE( 483)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Parent Right Note Dad",13,46,28,52),24,false,null(),null());
HXLINE( 485)			this->animation->addByPrefix(HX_("singUP-alt",86,62,b4,5f),HX_("Parent Up Note Mom",0c,7a,fe,ad),24,false,null(),null());
HXLINE( 487)			this->animation->addByPrefix(HX_("singDOWN-alt",cd,29,35,ba),HX_("Parent Down Note Mom",a5,85,9a,34),24,false,null(),null());
HXLINE( 488)			this->animation->addByPrefix(HX_("singLEFT-alt",f2,6f,48,8c),HX_("Parent Left Note Mom",60,d9,1d,c4),24,false,null(),null());
HXLINE( 489)			this->animation->addByPrefix(HX_("singRIGHT-alt",a9,0c,12,b9),HX_("Parent Right Note Mom",97,26,2f,52),24,false,null(),null());
HXLINE( 491)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 492)			this->addOffset(HX_("singUP",6a,52,21,b9),-47,24);
HXLINE( 493)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-1,-23);
HXLINE( 494)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-30,16);
HXLINE( 495)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-31,-29);
HXLINE( 496)			this->addOffset(HX_("singUP-alt",86,62,b4,5f),-47,24);
HXLINE( 497)			this->addOffset(HX_("singRIGHT-alt",a9,0c,12,b9),-1,-24);
HXLINE( 498)			this->addOffset(HX_("singLEFT-alt",f2,6f,48,8c),-30,15);
HXLINE( 499)			this->addOffset(HX_("singDOWN-alt",cd,29,35,ba),-30,-27);
HXLINE( 501)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 477)			goto _hx_goto_0;
            		}
...
HXLINE( 230)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("poly",4c,7e,5c,4a)) ){
HXLINE( 504)			::String library = null();
HXDLIN( 504)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("poly/poly_assets",d3,5d,2f,6c)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 504)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("poly/poly_assets",d3,5d,2f,6c)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 506)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Dad idle dance",80,2a,95,5c),24,false,null(),null());
HXLINE( 507)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Dad Sing note UP",b1,c0,cc,3e),24,false,null(),null());
HXLINE( 508)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Dad Sing Note DOWN",18,d8,98,b2),24,false,null(),null());
HXLINE( 509)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Dad Sing Note LEFT",bd,e7,da,b7),24,false,null(),null());
HXLINE( 510)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("dad sing note right",86,2f,34,6b),24,false,null(),null());
HXLINE( 512)			this->addOffset(HX_("idle",14,a7,b3,45),10,0);
HXLINE( 513)			this->addOffset(HX_("singUP",6a,52,21,b9),30,5);
HXLINE( 514)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),3,-120);
HXLINE( 515)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-7,-95);
HXLINE( 516)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-25,-165);
...
HXLINE( 417)			::String library = null();
HXDLIN( 417)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpai",20,f0,51,f1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 417)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpai",20,f0,51,f1)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 418)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Senpai Idle",78,62,c5,a9),24,false,null(),null());
HXLINE( 419)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("SENPAI UP NOTE",f3,26,c1,c4),24,false,null(),null());
HXLINE( 420)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("SENPAI LEFT NOTE",c7,90,76,f3),24,false,null(),null());
HXLINE( 421)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("SENPAI RIGHT NOTE",3a,91,70,75),24,false,null(),null());
HXLINE( 422)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("SENPAI DOWN NOTE",8c,76,ac,f4),24,false,null(),null());
HXLINE( 424)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 425)			this->addOffset(HX_("singUP",6a,52,21,b9),5,37);
HXLINE( 426)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 427)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),40,null());
HXLINE( 428)			this->addOffset(HX_("singDOWN",31,2a,ad,36),14,null());
HXLINE( 430)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 432)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 433)			this->updateHitbox();
HXLINE( 435)			this->set_antialiasing(false);
HXLINE( 416)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("senpai-angry",10,7a,b8,25)) ){
HXLINE( 437)			::String library = null();
HXDLIN( 437)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpai",20,f0,51,f1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 437)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpai",20,f0,51,f1)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 438)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Angry Senpai Idle",d9,cc,b4,52),24,false,null(),null());
HXLINE( 439)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Angry Senpai UP NOTE",52,97,34,df),24,false,null(),null());
HXLINE( 440)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Angry Senpai LEFT NOTE",e6,16,ee,25),24,false,null(),null());
HXLINE( 441)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Angry Senpai RIGHT NOTE",3b,66,8e,6b),24,false,null(),null());
HXLINE( 442)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Angry Senpai DOWN NOTE",ab,fc,23,27),24,false,null(),null());
HXLINE( 444)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 445)			this->addOffset(HX_("singUP",6a,52,21,b9),5,37);
HXLINE( 446)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 447)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),40,null());
HXLINE( 448)			this->addOffset(HX_("singDOWN",31,2a,ad,36),14,null());
HXLINE( 449)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 451)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 452)			this->updateHitbox();
HXLINE( 454)			this->set_antialiasing(false);
HXLINE( 436)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("spirit",31,bb,a9,bd)) ){
HXLINE( 457)			::String library = null();
HXDLIN( 457)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/spirit",15,cc,6d,43)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 457)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/spirit",15,cc,6d,43)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 458)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("idle spirit_",02,2f,37,04),24,false,null(),null());
HXLINE( 459)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("up_",a4,29,59,00),24,false,null(),null());
HXLINE( 460)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("right_",03,55,26,4e),24,false,null(),null());
HXLINE( 461)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("left_",78,fe,56,72),24,false,null(),null());
HXLINE( 462)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("spirit down_",8e,9f,fa,ae),24,false,null(),null());
HXLINE( 464)			this->addOffset(HX_("idle",14,a7,b3,45),-220,-280);
HXLINE( 465)			this->addOffset(HX_("singUP",6a,52,21,b9),-220,-240);
HXLINE( 466)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-220,-280);
HXLINE( 467)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),-200,-280);
HXLINE( 468)			this->addOffset(HX_("singDOWN",31,2a,ad,36),170,110);
HXLINE( 470)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ( (Float)(6) ))),null());
HXLINE( 471)			this->updateHitbox();
HXLINE( 473)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 521)		this->dance();
HXLINE( 523)		if (( (bool)(isPlayer) )) {
HXLINE( 525)			this->set_flipX(!(this->flipX));
HXLINE( 528)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 531)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 532)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 533)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 536)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 538)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 539)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 540)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_547_update)
HXLINE( 548)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 550)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 552)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 552)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 555)			Float dadVar = ( (Float)(4) );
HXLINE( 557)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 558)				dadVar = ((Float)6.1);
            			}
HXLINE( 559)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 561)				this->dance();
HXLINE( 562)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 566)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 569)			bool _hx_tmp;
HXDLIN( 569)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 569)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
HXLINE( 569)				_hx_tmp = false;
            			}
HXDLIN( 569)			if (_hx_tmp) {
HXLINE( 570)				this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            			}
            		}
...
void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_583_dance)
HXDLIN( 583)		if (!(this->debugMode)) {
HXLINE( 585)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 588)				bool _hx_tmp;
HXDLIN( 588)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 588)					_hx_tmp = (this->animation->_curAnim->name != HX_("scared",20,78,2a,3c));
            				}
            				else {
HXLINE( 588)					_hx_tmp = false;
            				}
HXDLIN( 588)				if (_hx_tmp) {
HXLINE( 590)					this->danced = !(this->danced);
HXLINE( 592)					if (this->danced) {
HXLINE( 593)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 595)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 588)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
HXLINE( 610)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 612)					this->danced = !(this->danced);
HXLINE( 614)					if (this->danced) {
HXLINE( 615)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 617)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 610)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
...
HXLINE( 599)				goto _hx_goto_21;
            			...
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 620)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 622)					this->danced = !(this->danced);
HXLINE( 624)					if (this->danced) {
HXLINE( 625)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 627)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 620)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
...
HXLINE( 630)				goto _hx_goto_21;
            			...
            			/* default */{
HXLINE( 638)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_644_playAnim)
HXLINE( 645)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 647)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 648)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 650)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 653)			this->offset->set(0,0);
            		}
HXLINE( 655)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 657)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 659)				this->danced = true;
            			}
            			else {
HXLINE( 661)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 663)					this->danced = false;
            				}
            			}
HXLINE( 666)			bool _hx_tmp;
HXDLIN( 666)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 666)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_675_addOffset)
HXDLIN( 675)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 675)		this->animOffsets->set(name,v);
            	}
