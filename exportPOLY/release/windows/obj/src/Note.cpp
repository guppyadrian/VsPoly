...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_187_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",187,0x1a8855ec)
...
HXLINE(  49)		this->set_x((this->x + 50));
HXLINE(  51)		this->set_y((this->y - ( (Float)(2000) )));
...
HXLINE( 141)			this->set_alpha(((Float)0.6));
HXLINE( 143)			Float _hx_tmp = this->x;
HXDLIN( 143)			this->set_x((_hx_tmp + (this->get_width() / ( (Float)(2) ))));
HXLINE( 145)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 154)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 152)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				}
            				break;
            				case (int)2: {
HXLINE( 148)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 150)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
...
HXLINE( 179)				 ::flixel::math::FlxPoint fh = prevNote->scale;
HXDLIN( 179)				fh->set_y((fh->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.8)) * ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) ))));
HXLINE( 180)				prevNote->updateHitbox();
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_187_update)
HXLINE( 188)		this->super::update(elapsed);
HXLINE( 190)		if (this->mustPress) {
HXLINE( 193)			bool _hx_tmp;
HXDLIN( 193)			if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 193)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * ((Float)0.5))));
            			}
            			else {
HXLINE( 193)				_hx_tmp = false;
            			}
HXDLIN( 193)			if (_hx_tmp) {
HXLINE( 195)				this->canBeHit = true;
            			}
            			else {
HXLINE( 197)				this->canBeHit = false;
            			}
HXLINE( 199)			bool _hx_tmp1;
HXDLIN( 199)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 199)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 199)				_hx_tmp1 = false;
            			}
HXDLIN( 199)			if (_hx_tmp1) {
HXLINE( 200)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 204)			this->canBeHit = false;
HXLINE( 206)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 207)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 210)		if (this->tooLate) {
HXLINE( 212)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 213)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
