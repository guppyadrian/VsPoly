...
HXLINE(  49)		 ::WatermarkOption _hx_tmp13 =  ::WatermarkOption_obj::__alloc( HX_CTX ,HX_("Turn off all watermarks from the engine.",85,98,13,ff));
HXLINE(  22)		this->options = ::Array_obj< ::Dynamic>::__new(3)->init(0,_hx_tmp5)->init(1,_hx_tmp10)->init(2, ::OptionCatagory_obj::__alloc( HX_CTX ,HX_("Misc",0c,7f,35,33),::Array_obj< ::Dynamic>::__new(4)->init(0,_hx_tmp11)->init(1,_hx_tmp12)->init(2,_hx_tmp13)->init(3, ::LockFlushedOption_obj::__alloc( HX_CTX ,HX_("Locks flushed so you need to beat it in hard again",10,7e,37,97)))));
