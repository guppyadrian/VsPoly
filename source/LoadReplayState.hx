...
*/
		addWeek(['Bitwit','Polygonal','Hexadec','Subaru'], 1, ['poly']);
        ...
        for(i in 0...controlsStrings.length)
        {
            ...
            controlsStrings[i] = string.split("time")[0] + " " + (rep.replay.songDiff == 3 ? "FLUSHED" : rep.replay.songDiff == 2 ? "HARD" : rep.replay.songDiff == 1 ? "EASY" : "NORMAL");
        }
