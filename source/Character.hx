...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				...
				animation.addByPrefix('shocked', 'BF hit', 12, false);
				animation.addByPrefix('shockHold', 'BF shock', 12, true);
			...
			case 'poly':
				frames = Paths.getSparrowAtlas('poly/poly_assets');
				...
				addOffset("singRIGHT", 3, -120);
				addOffset("singLEFT", -7, -95);
				addOffset("singDOWN", -25, -165);
	...
	public function dance()
	{
		if (!debugMode)
		{
			...
			{
				case 'gf':
					if (!animation.curAnim.name.startsWith('hair') && animation.curAnim.name != 'scared')
					{
						danced = !danced;
